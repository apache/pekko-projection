...
trait Replica {
  ...
  def getAdditionalQueryRequestMetadata: Optional[org.apache.pekko.grpc.scaladsl.Metadata]
  ...
  def toScala: org.apache.pekko.projection.grpc.replication.scaladsl.Replica
}
