...
object LicenseReport extends AutoPlugin {
  ...
  override lazy val projectSettings = Seq(
    ...
    licenseOverrides := {
      case DepModuleInfo("com.oracle.ojdbc", _, _) =>
        LicenseInfo(
          LicenseCategory("FUTC"),
          "Oracle Free Use Terms and Conditions",
          "https://docs.oracle.com/en/database/oracle/transaction-manager-for-microservices/22.3/tmmli/license.html#GUID-37A02AFD-9155-454F-82E1-BC1C9BF78431")
      case DepModuleInfo("org.jvnet.staxex", _, _) | DepModuleInfo("org.glassfish.jaxb", _, _) => LicenseInfo.CDDL_GPL
    },
