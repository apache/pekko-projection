...
object Dependencies {
  ...
  object Test {
    ...
    val mysqlDriver = "com.mysql" % "mysql-connector-j" % "8.4.0" % allTestConfig
    val msSQLServerDriver = "com.microsoft.sqlserver" % "mssql-jdbc" % "12.6.2.jre8" % allTestConfig
  ...
  object Examples {
    val hibernate = "org.hibernate" % "hibernate-core" % "6.5.2.Final"
