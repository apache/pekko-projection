...
object Dependencies {
  ...
  object Versions {
    ...
    val jackson = "2.21.2" // this should match the version of jackson used by pekko-serialization-jackson
    val logback = "1.5.32"
  }
  ...
  object Test {
    ...
    val msSQLServerDriver = "com.microsoft.sqlserver" % "mssql-jdbc" % "13.4.0.jre11"
  ...
  object Examples {
    val hibernate = "org.hibernate" % "hibernate-core" % "7.3.0.Final"
