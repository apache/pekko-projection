...
object Dependencies {
  ...
  object Versions {
    ...
    val jackson = "2.17.0" // this should match the version of jackson used by pekko-serialization-jackson
    val logback = "1.2.13"
  }
  ...
  object Test {
    ...
    val mysqlDriver = "com.mysql" % "mysql-connector-j" % "8.3.0" % allTestConfig
