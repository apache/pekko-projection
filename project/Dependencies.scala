...
object Dependencies {
  ...
  object Versions {
    ...
    val jackson = "2.22.3" // this should match the version of jackson used by pekko-serialization-jackson
    val logback = "1.6.4"
  }
  ...
  object Compile {
    ...
    val r2dbcPostgres = "org.postgresql" % "r2dbc-postgresql" % "1.1.3.RELEASE"
  ...
  object Test {
    ...
    val junitJupiterApi = "org.junit.jupiter" % "junit-jupiter-api" % "6.1.3" % "test"
    val junitJupiterEngine = "org.junit.jupiter" % "junit-jupiter-engine" % "6.1.3" % "test"
    val jupiterInterface = "com.github.sbt.junit" % "jupiter-interface" % "0.19.0" % "test"
    val junitPlatformLauncher = "org.junit.platform" % "junit-platform-launcher" % "6.1.3" % "test"
    ...
    val msSQLServerDriver = "com.microsoft.sqlserver" % "mssql-jdbc" % "13.6.0.jre11" % "test"
  ...
  object Examples {
    val hibernate = "org.hibernate" % "hibernate-core" % "7.4.10.Final"
