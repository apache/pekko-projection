...
abstract class SlickOffsetStoreSpec(specConfig: SlickSpecConfig)
  ...
  "The SlickOffsetStore" must {
    ...
    s"save and retrieve offsets of type org.apache.pekko.persistence.query.Sequence [$dialectLabel]" taggedAs
    (specConfig
      .tag) in {
    ...
    s"save and retrieve offsets of type org.apache.pekko.persistence.query.TimeBasedUUID [$dialectLabel]" taggedAs
    (specConfig
      .tag) in {
