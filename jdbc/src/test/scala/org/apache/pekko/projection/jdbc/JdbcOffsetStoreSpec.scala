...
import pekko.projection.jdbc.internal.JdbcSessionUtil.tryWithResource
import pekko.projection.jdbc.internal.JdbcSessionUtil.withConnection
import pekko.projection.jdbc.internal.JdbcOffsetStore
import pekko.projection.jdbc.internal.JdbcSettings
...
abstract class JdbcOffsetStoreSpec(specConfig: JdbcSpecConfig)
  ...
  override protected def beforeAll(): Unit = {
    ...
    Await.result(pekko.pattern.retry(() => offsetStore.createIfNotExists(), 20, 3.seconds), 60.seconds)
  }
  ...
  "The JdbcOffsetStore" must {
    ...
    s"save and retrieve offsets of type pekko.persistence.query.Sequence [$dialectLabel]" taggedAs (specConfig.tag) in {
